        ...
        {#if $mousecontrol}
            <section class="w-full relative flex justify-center bg-zinc-200 max-lg:portrait:hidden">
                ...
                <div class="h-[210px] sm:h-[300px] md:h-[350px] lg:h-[430px] xl:h-[500px] aspect-[5/2] flex justify-center items-center relative">
                    ...
                    <div role="button" tabindex="0" class="absolute w-full h-full group outline-none">
                        <img src="https://i.imgur.com/K3dGSiE.png" alt="banner" class="h-full absolute left-0 z-2 group-hover:scale-[1.005] group-focus-visible:scale-[1.0075] group-active:scale-[1] pointer-events-none transition">
                        <div class="absolute cursor-pointer left-[calc(12%/2)] trapezoid h-[calc(100%-(100%-81%))] w-[62%] top-[calc((100%-81%)/2)] bottom-[calc((100%-81%)/2)] z-3"></div>
                    </div>
                    <div role="button" tabindex="0" class="absolute w-full h-full group outline-none">
                        <img src="https://i.imgur.com/V1cYTpP.png" alt="" class="h-[46%] right-[calc(4.6%/2)] top-0 absolute z-2 group-hover:scale-[1.01] group-focus-visible:scale-[1.015] group-active:scale-[1] pointer-events-none transition">
                        <div class="absolute cursor-pointer right-[calc(12%/2)] h-[calc(37%)] w-[30.7%] top-[calc((100%-81%)/2)] bannertr z-3"></div>
                    </div>
                    <div role="button" tabindex="0" class="absolute w-full h-full group outline-none">
                        <img src="https://i.imgur.com/e7JRrts.png" alt="" class="h-[59%] right-[calc(4.6%/2)] bottom-0 absolute z-2 group-hover:scale-[1.01] group-focus-visible:scale-[1.015] group-active:scale-[1] pointer-events-none transition">
                        <div class="absolute cursor-pointer right-[calc(12%/2)] h-[calc(50%)] w-[28%] bottom-[calc((100%-81%)/2)] bannertb z-3"></div>
                    </div>
                </div> 
            </section>
        {/if}
        ...
        <nav class="sticky top-0 z-100 drop-shadow-lg drop-shadow-zinc-900/15">
            <section class="flex flex-col justify-center items-center bg-mainlight min-[900px]:bg-zinc-200">
                <div class="w-full min-[900px]:bg-mainlight flex flex-col items-center justify-center z-2">
                    ...
                    max-xs:px-[3.2vw] max-md:px-[32px]
                    h-[20vw] xs:h-[76px] md:landscape:h-[80px] lg:h-[80px]">
                        <!-- LEFT -->
                        <div class="flex justify-center items-center space-x-[20px]">
                            <!-- Logo -->
                        ...
                        <div class="space-x-[2vw] md:space-x-[10px] flex xs:justify-center xs:items-center">
                            {#if !$phone}
                                ...
                                <div class="relative sm:hidden">
                                    ...
                                    h-[50px] rounded-full aspect-square text-zinc-900 flex justify-center items-center relative overflow-hidden">
                                        <Icon icon="fa6-solid:magnifying-glass" class="text-[24px]" />
                                    </button>
                                </div>
                            ...
                            {:else}
                                ...
                                <div class="relative">
                                    ...
                                    h-[10vw] rounded-full aspect-square bg-zinc-500 text-mainlight border-2 border-zinc-900 flex justify-center items-center relative overflow-hidden">
                                        <Icon icon="material-symbols:person" class="text-[12vw] translate-y-[1.2vw] absolute" />
                                    </button>
                                </div>
                            {/if}
                        </div>
